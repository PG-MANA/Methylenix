...
pub const DIRECT_MAP_END_ADDRESS: VAddress = VAddress::new(0xffff_7fff_ffff_ffff);
...
pub const MALLOC_START_ADDRESS: VAddress = VAddress::new(0xffff_8000_0000_0000);
