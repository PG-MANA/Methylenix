...
const DIRECT_MAP_END_ADDRESS: VAddress = VAddress::new(0xffff_ffbf_ffff_ffff);
...
pub static mut DIRECT_MAP_START_ADDRESS: VAddress = VAddress::new(0xffff_ff80_0000_0000);
pub static mut HIGH_MEMORY_START_ADDRESS: VAddress = VAddress::new(0xffff_ff80_0000_0000);
